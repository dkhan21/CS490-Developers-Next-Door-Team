...
import { FiCheck, FiCheckCircle, FiSave } from "react-icons/fi";
...
const EncryptButton = () => {
  ...
  return (
    <motion.button style={{ fontWeight: 'bold', backgroundColor: 'white',fontSize: '12px' ,borderColor: "black", borderRadius: '5px', cursor: 'pointer', width: '80px', height: '30px', marginRight: '30px', paddingRight: '15px', }}
      whileHover={{
